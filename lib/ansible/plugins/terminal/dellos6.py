...
class TerminalModule(TerminalBase):
    ...
    terminal_stderr_re = [
        ...
        re.compile(br"Cannot add a static member to a LAG with dynamic members", re.I),
        re.compile(br"IP routing is not enabled.", re.I),
        re.compile(br"BGP is enabled.", re.I),
